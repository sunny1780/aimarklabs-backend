  ...
  return (
    <section className="py-14 sm:py-16 bg-[#F3F5F7]">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-[0.82fr_1.58fr] gap-8 lg:gap-x-12 items-start">
          {/* Mobile: 1.Heading 2.Paragraph 3.Items | Desktop: Left=Paragraph, Right=Heading+Items */}
          <p className="order-2 lg:order-1 lg:col-start-1 lg:row-start-1 text-[16px] leading-[1.5] text-[#5A666E] max-w-[520px] font-normal">
            We develop seamless digital experiences combining functionality, speed, and scalability to ensure smooth, intuitive interaction across all platforms and devices.
          </p>
          <div className="order-1 lg:order-2 lg:col-start-2 lg:row-start-1 flex flex-col gap-0">
            <h2 className="text-2xl sm:text-[36px] leading-[1.1] font-semibold text-[#1D1F24]">
              Technical Infrastructure
            </h2>
            <div className="mt-5 lg:mt-4 border-t border-[#C9CED6] pt-5 lg:pt-1.5 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
              <article>
