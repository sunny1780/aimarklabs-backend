    ...
    <section className="py-14 sm:py-16">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-[0.82fr_1.58fr] gap-8 lg:gap-12 items-start">
          <p className="text-[22px] sm:text-[32px] leading-[1.5] text-[#5D6773] max-w-[520px]">
          ...
          <div>
            <h2 className="text-[44px] sm:text-[54px] leading-[1.1] font-semibold text-[#1D1F24]">
            ...
            <div className="mt-5 border-t border-[#C9CED6] pt-5 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
              {architectureItems.map((item) => (
                <article key={item.title}>
                  <h3 className="text-[30px] sm:text-[36px] leading-[1.2] font-semibold text-[#22262C]">
                    {item.title}
                  </h3>
                  <p className="mt-3 text-[26px] sm:text-[30px] leading-[1.35] text-[#626B75]">{item.description}</p>
                </article>
              ))}
            </div>
          </div>
